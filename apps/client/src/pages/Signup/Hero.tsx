        ...
        <main className="mt-16 sm:mt-24 ">
          <div className="mx-auto max-w-7xl">
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="px-6 sm:px-12 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                <div>
              ...
              <div className="mt-16 sm:mt-24 lg:mt-0 lg:col-span-6">
                <div className="bg-white sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden shadow-xl">
                  <div className="px-4 py-8 sm:px-10">
                    ...
                    {/*		<span className="px-2 bg-white text-primaryText">Or</span>*/}
                    {/*	</div>*/}
                    {/*</div>*/}
                    <h4 className={''}>
                      Присоединяйтесь к ThesisHub и сделайте первый шаг на пути к
                      яркому академическому будущему!
                    </h4>
